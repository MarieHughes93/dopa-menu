...
export const catgegoryExample=[{
    category:"Appetizer", explanation: "Quick activities that will give you a quick burst without eating up your time. Satisfaction may not fully be felt after but you do not crave more. These activities are preferably under 15 minutes or max 30 minutes long.", example:"Quick set of jumping jacks. 5 minutes social media check. Stretch outside."
    },{
    category:"Entree", explanation:"Regular every-day activities that make you feel alive/energized. These activities usually require more than 30 minutes minimum for you to complete. They give you a full feeling while also being something productive or healthy.", example:"Walking the dog. Going to the Gym. Reading a book."
    },{
    ...
    category:"Dessert", explanation:"Activities you tend to overdo it on... maybe even binge? These are activities that require more time than any regular activity to achieve a feeling of satisfaction. These activities are also not productive.", "example":"Scrolling through memes. Play video games. Watch TV. Drawing. Recording tiktok video. "
    },{
    category:"Special", explanation:"Things you can do only so often. These have no time frame as they are not always available to do or if they are they should be sparingly. These should bring the largest amount of satifatction. As well as these are activities that should leave a lingering effect of feeling satisfied.", example:"Go ice skating. Go to a concert. Buying something new. Get a hair cut. Go on vacation/or weekend/stay-cation.  Get a new tattoo."}
    ]
